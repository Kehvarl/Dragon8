def initialize args
  ...
  args.state.cpu.set([0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
                      0xFFFF, 0xFFFE, 0xFEFC, 0xFCF9, 0xFBF2, 0xF0F0, 0xF8FC, 0xFEFF], 0x400)
  args.state.cpu.set([0xA400,0x6000,0x6100,0xD01F,0x6110,0xD01F,0x6008,0xD01F,0x6030,0xD01F,0x6038,0xD01F,0x6100,0xD01F,0xA410,0x6008,0x6100,0xD01F], 0x200)
